...
\begin{itemize}
  ...
  \item Segment 3 (Enthusiasts). Flexibility emerges as the
        ...
        about Segment 3 should be held more loosely. The
        Flexibility signal is consistent with the
        importance-performance map analysis in
        \citet{dadra2024tep}, which ranks Flexibility as the second
        most important driver of adoption intention overall; our
        segment-level view shows that the signal concentrates among
        the Enthusiasts rather than operating uniformly.
\end{itemize}

Table~\ref{tab:posterior} gives the full per-segment posterior
summary: mean, posterior standard deviation, 90\% credible
...
interpretable as a driver.

\begin{table}[H]
  \centering
  \caption{Per-segment posterior summary from the Gibbs sampler
           (10{,}000 post-burn-in iterations). Posterior means are
           the Bayesian point estimate; 90\% CI is the 5th to 95th
           posterior percentile; $P(\beta > 0)$ is the fraction of
           posterior mass above zero.}
  \label{tab:posterior}
  \small
  \begin{tabular}{l l r r r r}
    \toprule
    Predictor & Segment & Post.\ mean & Post.\ SD & 90\% CI & $P(\beta > 0)$ \\
    \midrule
    \multirow{3}{*}{Flexibility}
      & Seg 1 (Moderates)   &  0.01 & 0.15 & $[-0.24, 0.25]$ & 0.51 \\
      & Seg 2 (Skeptics)    & -0.04 & 0.08 & $[-0.17, 0.08]$ & 0.29 \\
      & Seg 3 (Enthusiasts) &  \textbf{0.40} & 0.30 & $[-0.09, 0.91]$ & \textbf{0.92} \\
    \midrule
    \multirow{3}{*}{Performance Expectancy}
      & Seg 1 (Moderates)   &  \textbf{0.28} & 0.15 & $[\phantom{-}0.03, 0.53]$ & \textbf{0.97} \\
      & Seg 2 (Skeptics)    &  \textbf{0.18} & 0.08 & $[\phantom{-}0.04, 0.31]$ & \textbf{0.99} \\
      & Seg 3 (Enthusiasts) &  0.22 & 0.34 & $[-0.34, 0.78]$ & 0.75 \\
    \midrule
    \multirow{3}{*}{Effort Expectancy}
      & Seg 1 (Moderates)   &  0.08 & 0.14 & $[-0.15, 0.31]$ & 0.72 \\
      & Seg 2 (Skeptics)    &  0.09 & 0.07 & $[-0.02, 0.20]$ & 0.92 \\
      & Seg 3 (Enthusiasts) &  0.06 & 0.28 & $[-0.38, 0.52]$ & 0.59 \\
    \midrule
    \multirow{3}{*}{Perceived Autonomy}
      & Seg 1 (Moderates)   & -0.02 & 0.13 & $[-0.24, 0.19]$ & 0.43 \\
      & Seg 2 (Skeptics)    &  0.09 & 0.07 & $[-0.03, 0.21]$ & 0.89 \\
      & Seg 3 (Enthusiasts) &  0.12 & 0.29 & $[-0.34, 0.60]$ & 0.67 \\
    \midrule
    \multirow{3}{*}{Perceived Competence}
      & Seg 1 (Moderates)   & -0.06 & 0.13 & $[-0.27, 0.16]$ & 0.33 \\
      & Seg 2 (Skeptics)    & -0.01 & 0.08 & $[-0.14, 0.12]$ & 0.44 \\
      & Seg 3 (Enthusiasts) &  0.03 & 0.27 & $[-0.40, 0.47]$ & 0.55 \\
    \midrule
    \multirow{3}{*}{Perceived Relatedness}
      & Seg 1 (Moderates)   &  0.11 & 0.15 & $[-0.14, 0.36]$ & 0.78 \\
      & Seg 2 (Skeptics)    &  0.09 & 0.09 & $[-0.05, 0.23]$ & 0.85 \\
      & Seg 3 (Enthusiasts) &  0.04 & 0.29 & $[-0.44, 0.52]$ & 0.56 \\
    \midrule
    \multirow{3}{*}{Perceived Usefulness}
      & Seg 1 (Moderates)   &  \textbf{0.28} & 0.14 & $[\phantom{-}0.05, 0.51]$ & \textbf{0.98} \\
      & Seg 2 (Skeptics)    &  \textbf{0.13} & 0.08 & $[-0.01, 0.26]$ & \textbf{0.94} \\
      & Seg 3 (Enthusiasts) &  0.02 & 0.28 & $[-0.44, 0.49]$ & 0.53 \\
    \midrule
    \multirow{3}{*}{Attitude}
      & Seg 1 (Moderates)   &  \textbf{0.25} & 0.12 & $[\phantom{-}0.05, 0.45]$ & \textbf{0.98} \\
      & Seg 2 (Skeptics)    &  \textbf{0.44} & 0.07 & $[\phantom{-}0.33, 0.55]$ & \textbf{1.00} \\
      & Seg 3 (Enthusiasts) & -0.04 & 0.28 & $[-0.50, 0.41]$ & 0.45 \\
    \bottomrule
  \end{tabular}
\end{table}
